...
import base64,lzma,ipaddress
n=ipaddress.ip_address(input())
#<jp.txt lzma -c9|zbase85rfc|pbcopy
print(int(any(n in ipaddress.ip_network(e.decode('utf-8')) for e in lzma.LZMADecompressor().decompress(base64.b85decode('''
